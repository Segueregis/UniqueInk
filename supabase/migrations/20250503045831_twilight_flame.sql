/*
  # Update tattoo images
  
  1. Changes
    - Remove invalid image references
    - Keep only images that exist in Supabase bucket
*/

-- Delete existing tattoos with invalid images
DELETE FROM tattoos 
WHERE image_url NOT LIKE 'https://oylqtgphuufoslmdconu.supabase.co/storage/v1/object/public/tattoos%';

-- Insert tattoos with valid images
INSERT INTO tattoos (
  title,
  description,
  image_url,
